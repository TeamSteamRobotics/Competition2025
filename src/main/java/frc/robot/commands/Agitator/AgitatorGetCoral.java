...
/** TODO: This one will probably need more logic */
public class AgitatorGetCoral extends Command {
  AgitatorSubsystem m_AgitatorSubsystem;
  AgitatorState desiredState;
  /** Creates a new AgitatorGetCoral. */
  public AgitatorGetCoral(AgitatorSubsystem agitatorSubsystem) {
    m_AgitatorSubsystem = agitatorSubsystem;
    addRequirements(agitatorSubsystem);
    desiredState = m_AgitatorSubsystem.StateList.get("GET_CORAL");
