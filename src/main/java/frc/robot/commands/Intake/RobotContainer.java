...
import frc.robot.commands.Tests.PivotTest;
import frc.robot.commands.Tests.RollerTest;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    //IntakeButton
    controller.leftBumper().whileTrue(new PivotTest(intake, -1));    
    //RetreatButton
    //TODO: Consider not using PID for setting speeds to zero?
